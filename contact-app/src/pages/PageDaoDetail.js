...
class PageDaoDetail extends Component {
  ...
  loadItem = async () => {
    await axios
      .post(
        'http://localhost:5000/daoDetail/',
        { chat_room_id: '-443191914' },
        {
          // headers: {
          ...
          <div>
            <Statistic.Group widths="five">
              <Statistic size="huge" color="red">
                ...
                <Statistic.Value>
                  {this.state.estimated_value + this.state.remained_balance}ETH
                </Statistic.Value>{' '}
                {/* Public_Account - whole_value */}
              </Statistic>

              <Statistic color="red">
                <Statistic.Label>
                  <br></br>Estimated Value
                </Statistic.Label>
                <Statistic.Value>
                  {this.state.estimated_value}ETH
                </Statistic.Value>{' '}
                {/* Public_Account - nft_total_value */}
              </Statistic>

              <Statistic>
                <Statistic.Label>
                  <br></br>Invested Balance
                </Statistic.Label>
                <Statistic.Value>
                  {this.state.invested_value}ETH
                </Statistic.Value>{' '}
                {/* Public_Account - (eth_gathered - eth_remain) */}
              </Statistic>

              <Statistic>
                <Statistic.Label>
                  <br></br>Remained Balance
                </Statistic.Label>
                <Statistic.Value>
                  {this.state.remained_balance}ETH
                </Statistic.Value>{' '}
                {/* Public_Account - eth_remain */}
              </Statistic>
            </Statistic.Group>
          </div>
        </Segment>
            ...
            <Item.Group divided>
              ...
              <Item>
                ...
                <Item.Content>
                  ...
                  {/* NFT_holding - token_id */}
                  <Item.Meta>
                    <span className="price">Purchased 2 ETH</span>{' '}
                    {/* NFT_holding - price_buy */}
                  ...
                  <Item.Extra>
                    ...
                    <Item>
                      <EstimateChart />{' '}
                      {/* NFT_holding - price_est 이거 historical 하게 필요 */}
                  ...
                  <Progress percent={80} inverted progress success>
                    {' '}
                    {/* 이거는,, 판매 투표율인데 판매 투표 event 때 telegram으로부터 받아와야할듯 */}
                    200 Consent token Needed for Sale
                  </Progress>
                </Item.Content>
              </Item>
              <br></br>
              {/* <Item>
                ...
                <Item.Content>
                  ...
                  <Item.Extra>
                    ...
                    {/* <Label icon='globe' content='Additional Languages' /> */}
              {/* <Item>
                      여기엔 차트가 들어갈거에요~~ 여기엔 차트가 들어갈거에요~~
                    </Item>
                  </Item.Extra>
                  <Item.Description>판매 투표율</Item.Description>
                  <Progress percent={80} inverted progress success></Progress>
                </Item.Content>
              </Item> */}
              <br></br>
            </Item.Group>
