    ...
    return (
      <div style={style} align="left">
        ...
        <Form onSubmit={this.handleSubmit}>
            ...
            <Table.Header>
              <Table.Row>
                <Table.HeaderCell width={2.5}>
                  <Form.Field required>
                    <label>telegram_room_id</label>
                    <Input
                      placeholder="텔레그램 챗방 ID"
                ...
                <Table.HeaderCell width={2.5}>
                  <Form.Field required>
                    ...
                    <Input
                      placeholder="감정가 대비 구매 투표 발동 역치"
                ...
                <Table.HeaderCell width={2.5}>
                  <Form.Field>
                    <label>governance distribution</label>
                    <Input
                      placeholder="투표권 분포(json)"
          ...
          <div align="center">
            <Button color="blue">PROPOSAL</Button>
          </div>
        </Form>
      </div>
    )
